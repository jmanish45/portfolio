...
import heroImage from '../assets/about/manish-hero.png';
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      {/* Static hero image until the reel video is supplied. */}
      <img
        src={heroImage}
        alt="Manish Jaiswal at a desk with a laptop"
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        {/* Right Side: Reel control retained for a future video upload. */}
        <div 
          data-aos="zoom-in"
          data-aos-delay="600"
          className="mt-8 md:mt-0 flex flex-row md:flex-col items-center gap-2 md:gap-3 cursor-not-allowed group self-start md:self-auto"
          aria-disabled="true"
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center opacity-80 shadow-[0_0_30px_rgba(255,255,255,0.1)]">
